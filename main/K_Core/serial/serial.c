...
uint32_t serial_performance_timer = 0;
...
void serial_init()
{
	...
	// serial_uart_init(UART_NUM_1, SERIAL_UART1_TXD_PIN, SERIAL_UART1_RXD_PIN, systemconfig.serial.baud, SERIAL_UART1_RTS_PIN, SERIAL_UART1_CTS_PIN, false);
