...
//#define LV_COLOR_TRANSP     lv_color_hex(0x000000)
/*=========================
   MEMORY SETTINGS
 *=========================*/
...
#define LV_FONT_CUSTOM_DECLARE //LV_FONT_DECLARE(font_en_12) LV_FONT_DECLARE(font_en_16) LV_FONT_DECLARE(font_en_bold_16) LV_FONT_DECLARE(font_en_bold_20) LV_FONT_DECLARE(font_en_bold_24) 
